...
[![Video Walkthrough](screenshot.png)](https://github.com/rubabuddin/tweeter/blob/master/twitter_walkthrough.mp4?raw=true)

## Notes

Cloning the UI of an existing app is often harder than it seems. Using ActiveAndroid allowed me to seamlessly incorporate my models with SQLite.
